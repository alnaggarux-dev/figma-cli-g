/**
 * shadcn/ui design system color data
 * Source: https://v3.shadcn.com/colors (default zinc theme)
 * Includes primitives + semantic token mappings for Light/Dark modes
 * Pure data — no logic, no dependencies
 */

// Same base palette as Tailwind, plus white/black
export const shadcnPrimitives = {
...
// Semantic tokens: map to primitives with Light/Dark mode values
